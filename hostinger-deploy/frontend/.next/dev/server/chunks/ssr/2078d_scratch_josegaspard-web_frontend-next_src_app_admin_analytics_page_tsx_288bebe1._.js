module.exports = [
"[project]/.gemini/antigravity/scratch/josegaspard-web/frontend-next/src/app/admin/analytics/page.tsx [app-ssr] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
function AnalyticsPage() {
    ...
    const [topPages, setTopPages] = (0, __TURBOPACK__imported__module__$5b$project$5d2f2e$gemini$2f$antigravity$2f$scratch$2f$josegaspard$2d$web$2f$frontend$2d$next$2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useState"])([]);
    ...
    const loadStats = async ()=>{
        try {
            ...
            __TURBOPACK__imported__module__$5b$project$5d2f2e$gemini$2f$antigravity$2f$scratch$2f$josegaspard$2d$web$2f$frontend$2d$next$2f$src$2f$utils$2f$logger$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["logger"].error('Failed to load analytics', error, 'AnalyticsPage.loadStats');
        } finally{
            setLoading(false);
        }
    };
...
//# sourceMappingURL=2078d_scratch_josegaspard-web_frontend-next_src_app_admin_analytics_page_tsx_288bebe1._.js.map